...
def train_model(model, num_classes, dataloaders, criterion, optimizer, device, dest_dir, num_epochs=25):
    ...
    # make lists that allow us to plot accuracy and loss for both train and val
    train_loss_list = []
    train_acc_list = []
    val_loss_list = []
    val_acc_list = []
    ...
    return best_model_state_dict, val_acc_history, train_acc_list, train_loss_list, val_acc_list, val_loss_list
